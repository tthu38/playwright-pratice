...
// @Severity(SeverityLevel.NORMAL)
// public void reuseSessionWithoutLogin() {
//     // Bước 1: Login + lưu session
//     loginPage.login(
//         ConfigReader.VALID_EMAIL,
//         ConfigReader.VALID_PASSWORD);
//     assertThat(page.getByText("Logged in as")).isVisible();
...
//     // Bước 2: Tạo context MỚI — dùng lại session
//     BrowserContext newContext = browser.newContext(
//         new Browser.NewContextOptions()
//             .setStorageStatePath(Paths.get("auth.json")));
//     Page newPage = newContext.newPage();

//     // Bước 3: Navigate — KHÔNG login
//     newPage.navigate(ConfigReader.BASE_URL);
//     System.out.println("✅ Navigate không cần login!");

//     // Bước 4: Verify vẫn đang login
//     assertThat(newPage.getByText("Logged in as")).isVisible();
//     System.out.println("✅ Vẫn login mà không cần đăng nhập lại!");

//     // Bước 5: Vào trang account — verify vào được
//     newPage.navigate(ConfigReader.BASE_URL + "/account");
//     assertThat(newPage).hasURL(ConfigReader.BASE_URL + "/account");
//     System.out.println("✅ Vào được trang account không cần login!");
